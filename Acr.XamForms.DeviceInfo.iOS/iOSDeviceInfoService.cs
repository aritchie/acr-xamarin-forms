using System;
using Acr.XamForms.DeviceInfo.iOS;
using MonoTouch.ObjCRuntime;
using MonoTouch.UIKit;
using Xamarin.Forms;


[assembly: Dependency(typeof(iOSDeviceInfoService))]

namespace Acr.XamForms.DeviceInfo.iOS {
    
    public class iOSDeviceInfoService : AbstractDeviceInfoService {
